...
create_clock [get_ports scan_clk]  -name DFT_CLK  -period 300  -waveform {0 150}
...
set_input_delay -clock DFT_CLK  60  [get_ports SE]
...
set_clock_groups -asynchronous -name REF_CLK_1 -group [list [get_clocks REF_CLK] [get_clocks ALU_CLK]] -group [list [get_clocks UART_CLK] [get_clocks RX_CLK] [get_clocks TX_CLK]] -group [get_clocks DFT_CLK]
