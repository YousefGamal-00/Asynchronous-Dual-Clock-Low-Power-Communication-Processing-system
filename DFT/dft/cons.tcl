...
create_clock -name    $DFT_CLK_NAME              \
             -period  $DFT_CLK_PER               \
             -waveform "0 [expr $DFT_CLK_PER/2]" \
             [get_ports scan_clk]
...
# ============================================================
# 4. set_dont_touch_network
# ============================================================

set_dont_touch_network [get_clocks {DFT_CLK REF_CLK UART_CLK ALU_CLK RX_CLK TX_CLK}]
...
set DFT_IN_delay  [expr 0.2*$DFT_CLK_PER]
set DFT_OUT_delay [expr 0.2*$DFT_CLK_PER]

#Constrain Functional Input Paths
set_input_delay $IN_RX_delay -clock RX_CLK   [get_port UART_RX_IN]

#Constrain DFT Input Paths
set_input_delay $DFT_IN_delay -clock DFT_CLK   [get_port SI]
set_input_delay $DFT_IN_delay -clock DFT_CLK   [get_port SE]

#Constrain Functional Output Paths
...
#Constrain DFT Output Paths
set_output_delay $DFT_OUT_delay -clock DFT_CLK   [get_port SO]
